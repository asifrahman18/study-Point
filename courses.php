                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="enroll2.php">
                                ...
                                <button id="button-88" type="submit">View Details</Details></button>
                            </form>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="enroll2.php">
                                ...
                                <button id="button-88" type="submit">View Details</button>
                            </form>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="enroll2.php">
                                ...
                                <button id="button-88" type="submit">View Detials</button>
                            </form>
                        </td>
